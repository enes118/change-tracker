...
export default function ConfigModal({ isOpen, onClose, onSave, initialData }) {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-container" style={{ maxWidth: '650px', maxHeight: '90vh', display: 'flex', flexDirection: 'column' }}>
        {/* Header (Fixed at top) */}
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', flex: 1 }}>
          ...
          <div className="modal-footer" style={{ flexShrink: 0, padding: '1rem 1.5rem', borderTop: '1px solid #e2e8f0', backgroundColor: '#f8fafc', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
